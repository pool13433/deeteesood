...
/**
 * This is the model class for table "product_album".
 *
 * The followings are the available columns in table 'product_album':
 * @property integer $alb_id
 * @property string $alb_picture
 * @property string $alb_date
 * @property integer $prod_id
 */
class ProductAlbum extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('alb_picture, alb_date, prod_id', 'required'),
			array('prod_id', 'numerical', 'integerOnly'=>true),
			array('alb_picture', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('alb_id, alb_picture, alb_date, prod_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProductAlbum the static model class
	 */
